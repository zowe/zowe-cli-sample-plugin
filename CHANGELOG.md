...
- Enhancement: Isolated the `send check-status` operation into its own command.
...
- Major: Updated the Zowe sample plug-in to be compatible with Zowe V3. [#140](https://github.com/zowe/zowe-cli-sample-plugin/pull/140)
  ...
  - Enhancement: Removed the pluginHealthCheck property and function which was intended to confirm the health of the plugin, but is no longer supported by the Zowe SDK.
