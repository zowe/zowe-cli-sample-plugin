...
describe("issue definition", () => {
    it("should match the snapshot", () => {
        ...
        let error;
        try {
            contents = fs.readFileSync(__dirname + "/../../../src/cli/issue/Issue.definition.ts").toString();
        } catch (e) {
            error = e;
            Imperative.console.error(`Error reading Issue.definition.ts Did you move the file? Details: ${e.message}`);
        }
