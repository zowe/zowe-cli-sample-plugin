...
describe("command-with-options definition", () => {
    it("should match the snapshot", () => {
        ...
        let error;
        try {
            contents = fs.readFileSync(__dirname + "/../../../../src/cli/issue/command_with_options/CommandWithOptions.definition.ts").toString();
        } catch (e) {
            error = e;
            Imperative.console.error(`Error readingCommandWithOptions.definition.ts Did you move the file? Details: ${e.message}`);
        }
