...
describe("profile-args definition", () => {
    it("should match the snapshot", () => {
        ...
        let error;
        try {
            contents = fs.readFileSync(__dirname + "/../../../../src/cli/list/profile-args/ProfileArgs.definition.ts").toString();
        } catch (e) {
            error = e;
            Imperative.console.error(`Error reading ProfileArgs.definition.ts Did you move the file? Details: ${e.message}`);
        }
