 ...
 */
export abstract class SendBaseHandler implements ICommandHandler {
    /**
    ...
    /**
     * Process a command in the send command group.
    ...
    public async process(params: IHandlerParameters): Promise<void> {
        this.mParams = params;
        // use the user's sample (or scrt) profile to create a session to the desired service
